...
const STRINGS = {
  ...
  vi: {
    ...
    save: 'Lưu',
    close: 'Đóng',
    transcriptLog: 'Bản gốc',
    translationLog: 'Bản dịch',
    historyCreatedLabel: 'Ngày tạo: ',
    historyLangLabel: 'Ngôn ngữ: ',
    historyDurationLabel: 'Thời lượng: ',
    historyUtterancesLabel: 'Số phát ngôn: ',
    historyExpired: 'Mục này đã hết hạn và không thể hiển thị.',
    historyEmptyFiltered: 'Lịch sử hết hạn đã được ẩn.',
    historyNoOriginal: '(không có bản gốc)',
    historyNoTranslation: '(không có bản dịch)',
    historyEditTitle: 'Chỉnh sửa tiêu đề',
    historyTitleSaved: 'Đã lưu tiêu đề',
    historyTitleError: 'Lưu tiêu đề thất bại',
    historyTitleTooLong: 'Tiêu đề tối đa 80 ký tự',
    historyTitleRequired: 'Vui lòng nhập tiêu đề',
    historyTitleInvalidChars: 'Tiêu đề chứa ký tự không hợp lệ',
    historySearchPlaceholder: 'Tìm kiếm phát ngôn…',
    historySearchClear: 'Xóa tìm kiếm',
    historySearchNoResults: 'Không có lịch sử phù hợp',
    historySearchCount: '{count} kết quả',
    preset: 'Cài đặt sẵn:',
    presetFast: 'Nhanh',
    presetBalanced: 'Cân bằng',
    presetStable: 'Ổn định',
    uiLangLabel: 'Ngôn ngữ giao diện',
    inputLangLabel: 'Ngôn ngữ đầu vào',
    outputLangLabel: 'Ngôn ngữ đầu ra',
    langAuto: 'Tự động nhận diện',
    errorFirebaseInit: 'Khởi tạo Firebase thất bại. Vui lòng kiểm tra cấu hình.',
    errorLoginRequired: 'Cần đăng nhập',
    errorLoginFailed: 'Đăng nhập thất bại: ',
    errorLogoutFailed: 'Đăng xuất thất bại: ',
    errorTranslation: 'Dịch thất bại',
    errorQuotaCheck: 'Không thể kiểm tra thời gian khả dụng. Vui lòng thử lại sau.',
    errorMonthlyExhausted: 'Đã hết thời gian sử dụng trong tháng.',
    errorDailyLimit: 'Đã đạt giới hạn hàng ngày (10 phút) cho gói Free.',
    planLabel: 'Gói:',
    monthlyRemaining: 'Hàng tháng:',
    ticketBalance: 'Vé còn lại:',
    total: 'Tổng:',
    nextReset: 'Đặt lại tiếp:',
    today: 'Hôm nay:',
    ...
    glossaryLabel: 'Từ điển (Bảng thuật ngữ)',
    glossaryHint: 'Mỗi dòng một mục: source=target',
    takeoverTitle: 'Đang dịch trên thiết bị khác',
    takeoverMessage: 'Thiết bị khác đang dịch. Vui lòng dừng ở đó, rồi bắt đầu ở đây.',
    takeoverStart: 'Bắt đầu trên thiết bị này (dừng các thiết bị khác)',
    takeoverKeep: 'Đóng',
    upgradeToPro: 'Nâng cấp lên Pro',
    upgrading: 'Đang xử lý...',
    billingSuccess: 'Nâng cấp hoàn tất!',
    billingPending: 'Đang áp dụng gói...',
    billingSyncDelayed: 'Đồng bộ mất thời gian hơn. Vui lòng tải lại sau.',
    billingCancelled: 'Đã hủy',
    billingError: 'Đã xảy ra lỗi',
    alreadyPro: 'Đang dùng gói Pro',
    manageSubscription: 'Quản lý đăng ký',
    buyTicket: 'Mua thêm',
    buyTicketProOnly: 'Mua thêm (chỉ Pro)',
    resyncQuota: 'Đồng bộ lại',
    resyncInProgress: 'Đang đồng bộ…',
    resyncFailed: 'Đồng bộ thất bại',
    resyncSuccess: 'Đã cập nhật thông tin quota',
    proRequiredHint: 'Chỉ dành cho gói Pro. Vui lòng nâng cấp.',
    purchasing: 'Đang mua...',
    ticketSuccess: 'Mua vé thành công!',
    ticketCancelled: 'Đã hủy mua',
    ticketSelectTitle: 'Chọn gói vé',
    ticketCheckoutError: 'Không thể bắt đầu thanh toán',
    proRequired: 'Chỉ dành cho Pro',
    billingStatusFree: 'Gói Free',
    billingStatusPro: 'Gói Pro',
    billingStatusCanceling: 'Đang hủy (có hiệu lực đến {date})',
    billingStatusPastDue: '⚠️ Quá hạn thanh toán. Vui lòng cập nhật phương thức thanh toán.',
    billingStatusActive: 'Đang hoạt động (gia hạn: {date})',
    companyInfo: 'Thông tin công ty',
    companyNote: '* Thanh toán và hủy, sử dụng "Quản lý đăng ký"',
    ...
    country: 'Quốc gia',
    taxIdLabel: 'Loại mã số thuế',
    taxIdValue: 'Mã số thuế',
    saveCompany: 'Lưu',
    editCompany: 'Chỉnh sửa thông tin công ty',
    companySaved: 'Đã lưu',
    companySavedWithStripe: 'Đã lưu (đồng bộ Stripe)',
    companySavedStripeSkipped: 'Đã lưu (chưa đồng bộ Stripe)',
    companySaveError: 'Lưu thất bại',
    errorPromptInjection: 'Phát hiện mẫu nhập không hợp lệ. Vui lòng kiểm tra lại.',
    errorNoTextToSummarize: 'Không có văn bản để tóm tắt',
    errorSummaryFailed: 'Tạo tóm tắt thất bại',
    errorInputTooLong: 'Dữ liệu nhập quá dài (vượt giới hạn)',
    networkDisconnected: 'Mất kết nối. Văn bản đã được lưu. Vui lòng kết nối lại và nhấn Start.',
    errorRateLimit: 'Đã bị giới hạn tốc độ. Vui lòng chờ rồi thử lại.',
    errorServerError: 'Lỗi máy chủ. Vui lòng thử lại sau.',
    pricingPlan: 'Bảng giá & Gói',
    privacyPolicy: 'Chính sách quyền riêng tư',
    termsOfService: 'Điều khoản dịch vụ',
    contact: 'Liên hệ',
    contactForm: 'Biểu mẫu liên hệ',
    support: 'Pháp lý & Hỗ trợ',
    contactResponseSla: 'Chúng tôi thường phản hồi trong 3 ngày làm việc.',
    buildLabel: 'Phiên bản',
    forceUpdate: 'Cập nhật mới nhất',
    forceUpdateRunning: 'Đang cập nhật…',
    forceUpdateFailed: 'Cập nhật thất bại',
    copyDiagnostics: 'Sao chép chẩn đoán',
    diagnosticsCopied: 'Đã sao chép chẩn đoán',
    diagnosticsCopyFailed: 'Sao chép thất bại',
    // STT quality i18n
    vadPresetLabel: 'Cài đặt môi trường',
    vadPresetQuiet: 'Yên tĩnh (phòng họp)',
    vadPresetNormal: 'Bình thường',
    vadPresetNoisy: 'Ồn ào (quán cà phê, v.v.)',
    vadPresetCustom: 'Tùy chỉnh (thủ công)',
    noiseReductionLabel: 'Giảm tiếng ồn',
    noiseReductionAuto: 'Tự động (mặc định API)',
    noiseReductionNearField: 'Tiêu chuẩn (mic gần)',
    noiseReductionFarField: 'Cao (mic xa)',
    noiseReductionOff: 'Tắt',
    langDetecting: 'Ngôn ngữ: Đang nhận diện…',
    langLocked: 'Ngôn ngữ: Đã khóa thành {lang}',
    langUncertain: 'Ngôn ngữ: Không chắc chắn',
    langLockedNotice: 'Đã khóa ngôn ngữ thành {lang}. (Nhấn để nhận diện lại)',
    langResetNotice: 'Đã khởi động lại nhận diện ngôn ngữ tự động.',
    langUncertainHint: 'Ngôn ngữ không rõ ràng. Chọn Nhật/Anh/Trung sẽ ổn định hơn.',
  },
  'zh-Hans': {
    login: '登录',
    logout: '登出',
